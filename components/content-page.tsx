  ...
  return (
    <div className=" ">
      <div className=" absolute z-30  ">
        ...
        ></Image>
        <Image
          className="absolute top-0 right-0 h-[1.5rem] w-[1.5rem] cursor-pointer "
          src="/options.svg"
          alt="nav button"
          width={24}
          height={24}
      ...
      <div className=" absolute top-0 h-full  p-8 border border-white  bg-[#FFF]  shadow-lg shadow-black/[0.03] md:w-auto  mt-[16.25rem]   px-5 pt-8  rounded-tl-[2rem] ">
        <div className="absolute  inset-0 w-full flex-col overflow-y-visible "></div>
        ...
        <div className="z-[99] flex-col self-start pr-[10.75rem] pl-6 whitespace-pre-line pt-5">
